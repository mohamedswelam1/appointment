-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'PROVIDER');
...
-- CreateIndex
CREATE INDEX "TimeSlot_providerId_idx" ON "TimeSlot"("providerId");
...
-- AddForeignKey
ALTER TABLE "TimeSlot" ADD CONSTRAINT "TimeSlot_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "Provider"("id") ON DELETE CASCADE ON UPDATE CASCADE;
